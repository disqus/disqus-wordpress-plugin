...
import { IRestResponse, disqusRestGet } from './rest';
...
ReactDOM.render(
    ...
    () => {
        ...
        disqusRestGet('settings', (response: IRestResponse<IAdminOptions>) => {
        ...
        disqusRestGet('sync/status', (response: IRestResponse<ISyncStatus>) => {
