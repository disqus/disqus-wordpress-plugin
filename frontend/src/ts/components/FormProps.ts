...
export interface IFormProps {
    ...
    onDateSelectorInputchange(stateKey: string, event: React.SyntheticEvent<HTMLInputElement>): void;
    ...
    onSubmitManualSyncForm(event: React.SyntheticEvent<HTMLFormElement>): void;
